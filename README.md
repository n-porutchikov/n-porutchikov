...
| Название второго проекта | **Задача:** Краткое описание бизнес-проблемы.<br/><br/>**Что сделано:** Основные шаги и методы.<br/><br/>**Результат:** Какой вывод или решение получил. | Python, Pandas |
