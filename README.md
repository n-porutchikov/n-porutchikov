...
| Название проекта | Что сделано | Стек |
|---|---|---|
| [Анализ продаж видеоигр в Steam](https://github.com/n-porutchikov/steam-sales-analysis) | Определил факторы, влияющие на продажи: цена, оценки, сезонность. Сбор данных через API, статистический анализ, визуализация. | Python, Pandas, SciPy, Matplotlib, Seaborn |
| Название второго проекта | Кратко: какую задачу решал | Python, Pandas |
| Название третьего проекта | Кратко: какую задачу решал | Python, SQL |
