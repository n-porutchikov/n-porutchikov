...
| [Исследование маркетплейса](https://github.com/n-porutchikov/olist-retention-analysis) | **Задача:** Оценить текущее состояние маркетплейса, выявить причины низкого удержания и определить Product/Market Fit.<br/><br/>**Что сделано:** Когортный анализ (retention), RFM-сегментация клиентов, PMF-анализ, расчёт продуктовых метрик (MAU, Revenue, LTV, churn_rate).<br/><br/>**Результат:** PMF отсутствует — 97% клиентов не возвращаются. Основные причины: проблемы с оплатой (25% заказов оформляются больше 15 часов) и задержки доставки (6.6%). | Python, Pandas, NumPy, Matplotlib, Seaborn |
