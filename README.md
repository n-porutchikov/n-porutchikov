...
|---|---|---|
| [Анализ продаж видеоигр в Steam](https://github.com/n-porutchikov/steam-sales-analysis) | Проверка гипотез о влиянии цены, оценок и сезонности на продажи игр. Сбор данных через Steam API, статистический анализ. | Python, Pandas, SciPy, Matplotlib, Seaborn |
